let tabAphabet = ["a", "z", "e", "r", "t", "y", "u", "i", "o", "p", "q", "s", "d", "f", "g", "h", "j", "k", "l", "m", "w", "x", "c", "v", "b", "n", "A", "Z", "E", "R", "T", "Y", "U", "I", "O", "P", "Q", "S", "D", "F", "G", "H", "J", "k", "L", "M", "W", "X", "C", "V", "B", "N"];
...
$changeWebColor.addEventListener("submit", (event) => {
	...
	document.documentElement.style.setProperty('--color-web-normalize', data.get("color-web-normalize"));
	document.documentElement.style.setProperty('--color-base-button', data.get("color-base-button"));
	document.documentElement.style.setProperty('--color-base-button-hover', data.get("color-base-button-hover"));
	document.documentElement.style.setProperty('--color-base-button-active', data.get("color-base-button-active"));
	document.documentElement.style.setProperty('--border-color', data.get("border-color"));
	document.documentElement.style.setProperty('--border-color-hover', data.get("border-color-hover"));
	document.documentElement.style.setProperty('--text-color', data.get("text-color"));
	document.documentElement.style.setProperty('--text-color-hover', data.get("text-color-hover"));
	document.documentElement.style.setProperty('--a-color', data.get("a-color"));
	document.documentElement.style.setProperty('--a-color-hover', data.get("a-color-hover"));
	document.documentElement.style.setProperty('--box-shadow', data.get("box-shadow"));
	document.documentElement.style.setProperty('--box-shadow-hover', data.get("box-shadow-hover"));
	document.documentElement.style.setProperty('--hr-color', data.get("hr-color"));
	document.documentElement.style.setProperty('--secret', data.get("secret"));
});

function preset1() {
	document.documentElement.style.setProperty('--color-web-normalize', '#008793');
	document.documentElement.style.setProperty('--color-base-button', '#0000c5');
	document.documentElement.style.setProperty('--color-base-button-hover', '#0028c5');
	document.documentElement.style.setProperty('--color-base-button-active', '#ffffff');
